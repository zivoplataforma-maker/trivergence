...
| M6-08 | memoria envenenada o corrupta                | digest al commit y recall; provenance tipado; trigger solo permite redacción en borrado | test de digest inconsistente y trigger de persistencia    |
...
| M6-10 | retención indefinida o borrado no observable | TTL obligatorio, vaciado de contenido/provenance, poda y eventos sanitizados            | test de forget, expiración y audit chain                  |
